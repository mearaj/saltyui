...
// This file is literally copied from https://gioui.org/x/component, for customizing with app
...
func (n *renderNavItem) Layout(gtx layout.Context, th *material.Theme) layout.Dimensions {
	...
	return layout.Inset{
		...
		return material.Clickable(gtx, &n.Clickable, func(gtx Gtx) Dim {
			return layout.Stack{}.Layout(gtx,
				layout.Expanded(func(gtx Gtx) Dim { return n.layoutBackground(gtx, th) }),
				layout.Stacked(func(gtx Gtx) Dim { return n.layoutContent(gtx, th) }),
			)
		})
	})
}
...
func (n *renderNavItem) layoutBackground(gtx layout.Context, th *material.Theme) layout.Dimensions {
	...
	if n.hovering {
		fill = component.WithAlpha(th.Palette.Fg, n.AlphaPalette.Hover)
	} else if n.selected {
		fill = component.WithAlpha(th.Palette.ContrastBg, n.AlphaPalette.Selected)
	}
...
func (m *NavDrawer) Layout(gtx layout.Context, th *material.Theme, anim *component.VisibilityAnimation) layout.Dimensions {
...
func (m *NavDrawer) LayoutContents(gtx layout.Context, th *material.Theme, anim *component.VisibilityAnimation) layout.Dimensions {
	if !anim.Visible() {
		return Dim{}
	}
...
func (m *NavDrawer) layoutNavList(gtx layout.Context, th *material.Theme, anim *component.VisibilityAnimation) layout.Dimensions {
	m.selectedChanged = false
	gtx.Constraints.Min.Y = 0
	m.navList.Axis = layout.Vertical
	return m.navList.Layout(gtx, len(m.items), func(gtx Gtx, index int) Dim {
...
func NewModalNav(modal *component.ModalLayer, title, subtitle string) *ModalNavDrawer {
